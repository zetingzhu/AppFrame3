...
class QuestionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dp_practive.setOnClickListener(object : View.OnClickListener {
            override fun onClick(v: View?) {
                startActivity(Intent(this@QuestionActivity, SizeActivity::class.java))
            }
        })
        onTouch_practive.setOnClickListener(object : View.OnClickListener {
            override fun onClick(v: View?) {
                startActivity(Intent(this@QuestionActivity, OnTouchActivity::class.java))
            }
        })
        arthmetic_practive.setOnClickListener(object : View.OnClickListener {
            override fun onClick(v: View?) {
...
//                }
        ...
        arthmetic_practive_2.setOnClickListener(object : View.OnClickListener {
            override fun onClick(v: View?) {
