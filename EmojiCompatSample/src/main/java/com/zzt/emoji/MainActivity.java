...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emojiButton.setOnClickListener(v -> {
            ...
            builder.setTitle("zzzzzzzzzzzzz");
            builder.setMessage("gggggggggggggggg");
        ...
        getLifecycle().addObserver(new MyObserverV2());
    }

    public class MyObserverV2 implements LifecycleObserver {
        @OnLifecycleEvent(Lifecycle.Event.ON_RESUME)
        void onResume() {
            Log.w(TAG, " MyObserverV2 -- onResume");
        }

        @OnLifecycleEvent(Lifecycle.Event.ON_PAUSE)
        void onPause() {
            Log.w(TAG, " MyObserverV2 -- onPause");
        }
    }
    ...
    protected void onResume() {
        super.onResume();
        Log.d(TAG, " MyObserver MainActivity -- onResume");
    }

    @Override
    protected void onPause() {
        super.onPause();
        Log.d(TAG, " MyObserver MainActivity -- onPause");
